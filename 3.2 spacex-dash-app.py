...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown', options = [{'label': 'All Sites', 'value': 'ALL'},{'label': 'site1', 'value': 'site1'}, {'label': 'site2', 'value': 'site2'}, {'label': 'site3', 'value': 'site3'}], placeholder = "Select a Launch Site here", searchable = True),
                                html.Br(),
